...
* Crear los usuarios de administraci�n:

** Ubicarse en el directorio: %JBOSS_HOME%\bin\

** Ejecutar el comando: add-usert "archivo:add-user.bat"

*** Management User (mgmt-users.properties): Seleccionar la opci�n: a
...
* Desplegar la aplicaci�n desde la consola de administraci�n del wildfly
